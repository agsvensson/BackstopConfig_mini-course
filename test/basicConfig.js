...
const projectId = "coursifyme"; // Replace the value "sample project" by the id of your project. It can be any string (e.g., "my-website").
...
const relativeUrls =[
  ...
  "/courses/testes-automatizados-com-cypress-basico",
];
